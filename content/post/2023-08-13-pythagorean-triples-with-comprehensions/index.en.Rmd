...
it means there's a lot to get through before you even get to a "Hello, World!" 
...
triple) and their sum is 24. I discussed the Pythagorean triples in my [last post](https://jcarroll.com.au/2023/08/11/wrapping-c-code-in-an-r-package/) - no 
...
about how learning about lisp quoting helps understand more of the tidyverse. This 
also doesn't have comprehensions so it relies on loops, and again, just prints the 
...
inscrutable. Still, far from unreadable, I'd say.
...
Again, we're back to a loop, but most if it is straightforward assignments
...
![Calculating the Pythagorean Triple with perimeter 24 in several languages at once](images/polyglot_triangles.png)

I still think the Haskell solution shines above all the rest. It has all of the 
simplicity and language richness with none of the boilerplate. 

Following my last post, [Kaz](https://fosstodon.org/@Kazinator@mstdn.ca) mentioned to me 
