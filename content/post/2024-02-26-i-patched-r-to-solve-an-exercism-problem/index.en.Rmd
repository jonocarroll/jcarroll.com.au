...
non-trivial (beyond printing `"Hello, World!"`) exercies in any of a handful of
...
`M` (modified). This confused me, until I relised that as part of the build process, R creates 
