...
the becomes quite apparent once you see the keyword `deriving` (for typeclasses) 
...
One of the first, overly simple examples was to output some HTML for a static site. 
