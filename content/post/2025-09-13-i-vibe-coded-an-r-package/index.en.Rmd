...
I needed to fetch, and then tweaked `{wanikanir}` to use `{httr2}` (with
...
but this was going to take a very long time. Here's where I got to after an
entire evening hacking away
...
implementation costs." I think it was Geoff Huntley who said in his
