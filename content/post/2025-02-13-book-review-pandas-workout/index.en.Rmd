...
What really blew my mind was the behaviour around joining two `Series` with overlapping 
indexes; the join is explicitly based on the index, so `'a'` matches to `'a'` and 
...
but that points to a repository of the _exercises_, not the data. These sort of 
...
hear back from the author about any of them.
