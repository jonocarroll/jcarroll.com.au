...
internals, but I was surprised that I could not find a clear guide towards exactly how a vectorization works at the deepest level.

<!--more-->

I've long been interested in exactly _how_ R works - not quite enough for me to learn _all_ the
internals, but I was surprised that I could not find a clear guide towards exactly how a `for` loop 
