...
vec + 1 => 1 + vec => 1 + x is at address 2[vec]
...
vec + 5 => 5 + vec => 5 + x is at address 5[vec]
```

and it all works out... `5[x]` is valid, and corresponds to the same address as `x[5]`.
...
it finds a non-zero element, it prints it
