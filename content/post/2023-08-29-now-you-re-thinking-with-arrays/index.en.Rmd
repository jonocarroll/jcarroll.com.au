...
differently" and I kept wondering why I agreed with the statement but didn't think 
too much of it. I believe I've figured out that it's _because_ I happened to have 
...
of the co-creators of Go and UTF-8 - it's a great interview full of history and a lot 
of name dropping. 
...
The talk he mentions is linked in the shownotes as ["Stop Writing Dead Programs" by Jack Rusher (Strange Loop 2022)](https://youtu.be/8Ab3ArE8W3s&t=434) (linked to the relevant timestamp) where 
Jack shows how to add `1` to a vector of values. He demonstrates that in some 
languages there's lots you need to write that has **nothing** to do with the problem itself; 
...
between the differences between R (column-major) and python (row-major), and importantly, 
