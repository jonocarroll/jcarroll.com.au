...
![random x86 instructions](images/X86_Assembly_Listing_for_ComplexAdd.png)
...
Yes, that was a long time ago, but I never wrote up what I did, and now seems like a good time to get really distracted.
...
runasm(hello_asm)
```
and I find that honestly, ridiculous.
